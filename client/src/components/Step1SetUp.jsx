                    ...
                    <div className='space-y-5'>
                        {
                            [
                                ...
                                },
                                {
                                    ...
                                    text: "Interactive Video Interview",
                                },
                                {
                                    icon: <FaMicrophoneAlt className="text-green-600 text-xl" />,
                                    text: "Smart Voice Response",
                                },
                                {
                                ...
                                <motion.div key={index}
                                    ...
                                    className='flex items-center space-x-4 bg-white p-4 rounded-xl shadow-sm cursor-pointer border border-transparent hover:border-green-200 transition-all'>
                                    {item.icon}
